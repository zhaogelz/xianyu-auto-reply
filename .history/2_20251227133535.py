...
# 永久有效期补丁：绕过日期验证
#用法：使用镜像：zhaogelzz/lz:xianyu-auto-reply  运行，运行后替换XianyuAutoAsync.py内容为2.py的内容
try:
...
class XianyuLive:
            ...
            try:
                ...
                try:
                    ...
                    if 'qq.com' in email_user.lower() or 'qq' in smtp_server.lower():
                        ...
                        suggestions.append("某些邮箱服务商需要使用授权码而不是���录密码")
    ...
    async def send_heartbeat(self, ws):
        ...
        if ws.closed:
            raise ConnectionError("WebSocket连接已关闭，无法发���心跳")
